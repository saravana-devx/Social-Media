...
const SinglePost: React.FC<SinglePostProps> = ({ post }) => {
  return (
    ...
    >
      ...
      {/* Post Actions (pixel-perfect copy of your design) */}
      <div
        className="
      ...
      "
      >
        <PostAction label={`Liked (${post.likes.length})`}>
          <svg
        ...
        <PostAction label={`Comments (${post.comments.length})`}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
