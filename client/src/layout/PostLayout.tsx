...
import Comment from "./CommentLayout";
import { ImageZoom } from "@/components/ui/shadcn-io/image-zoom";

const SinglePost: React.FC = () => {
  return (
    <div className="bg-card w-full md:w-4/5 lg:w-2/5 mx-auto mt-6 p-6 rounded-xl shadow-md flex flex-col gap-4 font-sans border border-border">
      {/* Post Header */}
      <div className="flex gap-4 items-center">
        ...
        <div>
          <p className="text-foreground font-semibold">
            Lori Ferguson{" "}
            <span className="text-muted-foreground font-normal">&middot; 2 hr ago</span>
          </p>
          <p className="text-muted-foreground text-sm">Web Developer at StackBros</p>
        </div>
      </div>
